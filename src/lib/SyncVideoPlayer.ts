...
class SyncVideoPlayer {
	...
	private async moveStateTo(
		state: PlayerState,
		success?: (newState: PlayerState, oldState: PlayerState) => void,
		fail?: (newState: PlayerState, oldState: PlayerState) => void
	) {
	...
	public addVideoPlayers(
		videoPlayers: Array<VideoPlayerOptions> | undefined
	) {
